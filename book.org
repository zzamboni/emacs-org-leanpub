...
Testing link: [[*Code block execution and output processing][Code block execution and output processing]]
...
#+begin_code
This table is generated programmatically! See the code in [[*Code block execution and output processing][Code block execution and output processing]].
#+end_code
