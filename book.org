...
#+begin_tip
For a full working configuration example, check out my [[https://zzamboni.org/post/my-emacs-configuration-with-commentary/][full Emacs configuration]]. Feel free to skip this section if you are an experienced Emacs user and have your configuration set up already, but please check at least the [[https://zzamboni.org/post/my-emacs-configuration-with-commentary/#publishing-to-leanpub][Publishing to Leanpub]] section!
#+end_tip
