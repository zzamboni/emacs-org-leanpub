...
However, you can produce different types of exports. Subset export can be particularly useful if you want to do a quick preview of the rendering of your book in PDF, without producing all the supported formats. This results in a much shorter rendering time, which allows you to preview and iterate much faster.

The contents of the subset preview is determined by the =manuscript/Subset.txt= file. Its contents can be determined in several ways:
...
Once you have exported your book, you have to commit the changes to your git repository, and push the changes to GitHub:
