...
For some time I used [[https://circleci.com/][CircleCI]] for my Leanpub automation. The configuration for this book lives in the [[https://github.com/zzamboni/emacs-org-leanpub][repository]] under =dot-circleci/config.yml=. The file uses my [[https://circleci.com/developer/orbs/orb/zzamboni/leanpub][=zzamboni/leanpub= CircleCI orb]], which wraps the Leanpub API calls behind a few ready-made jobs.

Here is the complete workflow definition:

#+include: "dot-circleci/config.yml" src yaml
...
#+include: ".github/workflows/leanpub.yml" src yaml
